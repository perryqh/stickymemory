...
describe WordTokenizer do
  describe 'parsing' do
    ...
    it "should return first letters with punctuation and formatting" do
      @word_tokenizer.first_letter_text.should eql "<p>T    i  a <span id='2'>g     t    </span> t  m       . <p>S      s       .</p>W    a c    , i  a t   . J       j  !&nbsp;W    s     ?"
    end
